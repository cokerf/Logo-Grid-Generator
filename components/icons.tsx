...
export const HandlesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 18C4 18 8 10 18 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <circle cx="18" cy="8" r="2" fill="currentColor"/>
    <rect x="3" y="17" width="4" height="4" rx="1" fill="currentColor"/>
    <path d="M18 8L21 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
